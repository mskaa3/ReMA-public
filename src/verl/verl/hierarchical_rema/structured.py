...
_SKILL_TAG_ALIASES = {
    ...
    "calculation_worker": "arithmetic",
    "numeric_evaluation": "arithmetic",
    "fractions": "arithmetic",
    "fraction": "arithmetic",
    "symbolic": "symbolic_manipulation",
    "symbolic_algebra": "symbolic_manipulation",
    "symbolic_manipulation_worker": "symbolic_manipulation",
    "equation_solving": "equations",
    "geometry_trigonometry": "geometry",
    "geometry_relation": "geometry",
    "geometry_relation_worker": "geometry",
    "calculus_analysis": "analysis",
    "function_analysis": "analysis",
    "function_analysis_worker": "analysis",
    "combinatorics_probability": "combinatorics",
    "counting": "combinatorics",
    "casework": "combinatorics",
    "counting_casework": "combinatorics",
    "counting_casework_worker": "combinatorics",
    "number_theory_discrete": "number_theory",
    "logic_constraints": "discrete_math",
    "logic_constraints_worker": "discrete_math",
    "constraint_reasoning": "discrete_math",
...
def _infer_required_skills_from_instruction(instruction: str) -> List[str]:
    ...
    keyword_groups: tuple[tuple[List[str], tuple[str, ...]], ...] = (
        ...
        (["combinatorics", "discrete_math"], ("case split", "split into cases", "consider cases", "handle each case", "casework")),

...
COMMAND="unset ROCR_VISIBLE_DEVICES;python3 -m pip install jsonlines==4.0.0 vllm==0.8.5.post1;cd src/verl && pip install -e .;python3 -m verl.trainer.main_ppo --config-path=/home/ajanz/projects/ReMA-public/config --config-name=rema-rl.yaml"

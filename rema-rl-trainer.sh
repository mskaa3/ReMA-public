...
COMMAND="unset ROCR_VISIBLE_DEVICES;pip install --upgrade math-verify[antlr4_13_2];export PYTHONPATH=/root/ReMA-public/src:/verl:\$PYTHONPATH;python3 -m verl.rema_trainer.main_ppo --config-path=/home/ajanz/projects/ReMA-public/config --config-name=rema-rl.yaml"

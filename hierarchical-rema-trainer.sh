...
SELECTOR_MAX_NEW_TOKENS=${SELECTOR_MAX_NEW_TOKENS:-0}
...
TRAIN_SUBSET_SIZE=${TRAIN_SUBSET_SIZE:-${TASKS_PER_EPOCH:-0}}
...
SEED=${SEED:-42}
TRAIN_SUBSET_ROUNDS=${TRAIN_SUBSET_ROUNDS:-${NUM_EPOCHS:-1}}
